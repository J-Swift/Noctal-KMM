...
//        var urlPath = dto.urlPath;
//        if (urlPath == null)
//        {
//            urlPath = dto.typeOfStory == StoryType.AskHn ? "https://news.ycombinator.com" : "<unknown>";
//        }
            item.apply {
                url = dto.urlPath ?: "https://news.ycombinator.com"
                title = dto.title
...
//            timeAgo = dto.
    ...
    private suspend fun fetchStories() {
        ...
        val items = db.realm.writeBlocking {
